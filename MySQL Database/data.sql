...
# ('Sara','man','sara.fletcher@myemail.co.uk','44-0191-5678901','woman123','443snf9232vdsidikfo2sh11dshdshsdhdshsdhdshsdhdshdshhsdf','User');
#
...
# truncate  userAccounts;
#
# select * from userAccounts;

select * from RandomLotteryDraw;
